package com.tianyalan.product.core.test.integration;
...
public class ProductSyncTest extends TestBase {
	...
	public void testProductSync(){
		...
		List<Vendor> vendors = vendorLocalService.getVendorsWithVendorSystem();
